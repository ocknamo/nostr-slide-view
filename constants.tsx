...
// Using SVG directly for icons to ensure no external dependency breaks if lucide-react isn't perfect in environment
export const Icons = {
  Play: () => (
  ...
  Zap: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
  ),
  X: () => (
