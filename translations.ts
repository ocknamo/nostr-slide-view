...
export const translations = {
  ja: {
    ...
    steps: [
      { title: "スレッドを作る", desc: "Nostrで画像付きの投稿をツリー形式で投稿します。" },
      { title: "画像を載せる", desc: "各投稿に画像を1枚載せます。本文は説明文になります。" },
      { title: "IDを貼り付ける", desc: "最初の投稿のnevent1...をコピーして貼り付けます。" }
    ],
    deck: {
      back: "スライドを終了して戻る",
      share: "このプレゼンを共有",
  ...
  en: {
    ...
    steps: [
      { title: "Create Thread", desc: "Post a series of images as a reply thread on Nostr." },
      { title: "Attach Images", desc: "Attach one image per reply. The text becomes the caption." },
      { title: "Paste ID", desc: "Copy the ID (nevent1...) of the first post and paste it here." }
    ],
    deck: {
